...
window.onload = function() {
    ...
    var resizePreviewMask = function() {
        ...
        if ($('#previewMask').width() > $('#previewMask').height()) {
            $('#previewMaskImg').attr("src", "assets/img/print_mask_horizontal.png");
            $('#downloadMaskImg').attr("src", "assets/img/print_mask_horizontal.png");

        } else {
            $('#previewMaskImg').attr("src", "assets/img/print_mask_vertical.png");
            $('#downloadMaskImg').attr("src", "assets/img/print_mask_vertical.png");
        }
    };
